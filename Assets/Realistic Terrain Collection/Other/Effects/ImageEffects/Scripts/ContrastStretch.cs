...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class ContrastStretch : MonoBehaviour
    {
        ...
        /// The limit on the minimum luminance (0...1) - we won'_t go above this.
        public float limitMinimum = 0.2f;

        /// The limit on the maximum luminance (0...1) - we won'_t go below this.
        ...
        void Start()
        {
            // Disable if we don'_t support image effects
        ...
        private void CalculateAdaptation( Texture curTexture )
        {
            ...
            // clear destination RT so its contents don'_t need to be restored
