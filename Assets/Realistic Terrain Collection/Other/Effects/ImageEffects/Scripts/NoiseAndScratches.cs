...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class NoiseAndScratches : MonoBehaviour
    {
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination)
        {
            ...
            {
                scratchTimeLeft = Random.value * 2 / scratchFPS; // we have sanitized it earlier, won'_t be zero
            ...
            float grainScale = 1.0f / grainSize; // we have sanitized it earlier, won'_t be zero
